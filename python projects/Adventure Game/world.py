...
class EnemyTile(MapTile):
    def __init__(self, x, y):
        r = random.random()
        if r < 0.40:
            self.enemy = enemies.GaliKaGunda()
            self.alive_text = "\n\nYou've encountered an enemy known as 'Gali Ka Gunda'" \
                              "ek aisa insaan jo marne ko to machhar bhi na mar paye " \
                              "lekin samjhta khud ko Arun Gawli hain! "
            self.dead_text = "\nYou've defeated the enemy, just what was expected! Easy-Peasy "
        elif r < 0.50:
            ...
            self.dead_text = "\nThe dead Ogre reminds you of your triumph. " \
                             "But there's more to come so you better be ready for it! "
        elif r < 0.90:
